...
if(isset($_POST['submit']))
{
    ...
    if ($sundaytime == null || $sundaytime == '00:00' || $sundaytime == '' || $sundaytime == '00:00:00' )
    {
        $sunday=0; 
    } else {
        $sunday=1;
    ...
    if ($mondaytime == null || $mondaytime == '00:00' || $mondaytime == '' || $mondaytime == '00:00:00' )
    {
        $monday=0; 
    } else {
        $monday=1;
    ...
    if ($tuesdaytime == null || $tuesdaytime == '00:00' || $tuesdaytime == '' || $tuesdaytime == '00:00:00' )
    {
        $tuesday=0; 
    } else {
        $tuesday=1;
    ...
    if ($wednesdaytime == null || $wednesdaytime == '00:00' || $wednesdaytime == '' || $wednesdaytime == '00:00:00' )
    {
        $wednesday=0; 
    } else {
        $wednesday=1;
    ...
    if ($thursdaytime == null || $thursdaytime == '00:00' || $thursdaytime == '' || $thursdaytime == '00:00:00' )
    {
        $thursday=0; 
    } else {
        $thursday=1;
    ...
    if ($fridaytime == null || $fridaytime == '00:00' || $fridaytime == '' || $fridaytime == '00:00:00' )
    {
        $friday=0; 
    } else {
        $friday=1;
    ...
    if ($saturdaytime == null || $saturdaytime == '00:00' || $saturdaytime == '' || $saturdaytime == '00:00:00' )
    {
        $saturday=0; 
    } else {
        $saturday=1;
    ...
    $query = "UPDATE `course` SET `subject`=?, `grade`=?, `sunday`=?, `sunday_time`=?, `monday`=?, `monday_time`=?, `tuesday`=?, `tuesday_time`=?, `wednesday`=?, `wednesday_time`=?, `thursday`=?, `thursday_time`=?, `friday`=?, `friday_time`=?, `saturday`=?, `saturday_time`=? WHERE `id`=?";
    $stmt = $mysqli->prepare($query);
    ...
    // Bind parameters
    $stmt->bind_param("ssssssssssssssssi", $subject, $coursegrade, $sunday, $sundaytime, $monday, $mondaytime, $tuesday, $tuesdaytime, $wednesday, $wednesdaytime, $thursday, $thursdaytime, $friday, $fridaytime, $saturday, $saturdaytime, $course_id);
    ...
    if ($result) {
        ...
        $_SESSION['success_message'] = "تم تعديل تفاصيل الدورة بنجاح.";
        include_once 'PopUpAlert.php';
        
    } else {
        $_SESSION['main_success_message'] = "خطأ في المعطيات";
        $_SESSION['success_message'] = "لم تتم التعديلات في هذه الدورة, حاول مرة اخرى";
        include_once 'PopUpAlert.php';
    }
    ...
    <div class="container">
        <form action="" method="post">
            ...
            <div class="button-container">
                    <button name="submit" type="submit">تعديل تفاصيل الدورة</button>
                </div>
            </div>
